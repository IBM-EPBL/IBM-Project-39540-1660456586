...
conn = ibm_db.connect(
    'ba99a9e6-d59e-4883-8fc0-d6a8c9f7a08f.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud PORT=31321;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=kqt79377;PWD=P0HiuD4lI39akPNU', '', ''
)
